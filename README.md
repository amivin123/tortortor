 ...
 * [dht](https://github.com/amivin123/dhtor)
 * [bencode](https://godoc.org/github.com/amivin123/tortortor/bencode)
 * [tracker](https://godoc.org/github.com/amivin123/tortortor/tracker)

## Installation

Install the library package with `go get github.com/amivin123/tortortor`, or the provided cmds with `go get github.com/amivin123/tortortor/cmd/...`.

## Library examples

There are some small [examples](https://godoc.org/github.com/amivin123/tortortor#pkg-examples) in the package documentation.
...
Communication about the project is primarily through [Gitter](https://gitter.im/anacrolix/torrent) and the [issue tracker](https://github.com/amivin123/tortortor/issues).
...
Downloads torrents from the command-line. This first example does not use `godo`.
	...
	$ go get github.com/amivin123/tortortor/cmd/torrent
...
torrentfs mounts a FUSE filesystem at `-mountDir`. The contents are the torrents described by the torrent files and magnet links at `-metainfoDir`. Data for read requests is fetched only as required from the torrent network, and stored at `-downloadDir`.
    ...
    $ mkdir mnt torrents
    $ godo github.com/amivin123/tortortor/cmd/torrentfs -mountDir=mnt -metainfoDir=torrents &
    $ cd torrents
...
Creates a magnet link from a torrent file. Note the extracted trackers, display name, and info hash.
    ...
    $ godo github.com/amivin123/tortortor/cmd/torrent-magnet < ubuntu-14.04.2-desktop-amd64.iso.torrent
