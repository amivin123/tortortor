...
import (
	...
	"github.com/amivin123/tortortor/iplist"
	"github.com/amivin123/tortortor/metainfo"
...
func TestBoltPieceCompletionClosedWhenClientClosed(t *testing.T) {
	...
	require.NoError(t, err)
	cl.Close()
	// And again, https://github.com/amivin123/tortortor/issues/158
	cl, err = NewClient(cfg)
	require.NoError(t, err)
	cl.Close()
}
...
// https://github.com/amivin123/tortortor/issues/114
